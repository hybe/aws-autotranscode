...
This is an AWS Lambda function that works as an automated HLS streaming media encoder triggered by new files in S3, compatible with testing locally thanks to the Lambda boilerplate by [SC5](http://sc5.io/). Inspiration from the [Sitebase example](https://gist.github.com/Sitebase/1004af7d738929d0a7f1) on github. 
